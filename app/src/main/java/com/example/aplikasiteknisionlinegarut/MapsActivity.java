...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    LocationCallback mLocationCallback = new LocationCallback() {
        ...
        public void onLocationResult(LocationResult locationResult) {
            ...
            if (locationList.size() > 0) {
                ...
                //move map camera
                mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(latLnguser, 13));
            }
        }
    };
    ...
    private void getLokasi() {
        ...
        if(home.tek_hp == true){
            url = "http://gamnim.my.id/t_hp.php";
        }
        else if (home.tek_motor == true){
            url = "http://gamnim.my.id/t_motor.php";
        }
        else if(home.tek_alatmusik == true){
            url = "http://gamnim.my.id/t_alatmusik.php";
        }
        else if (home.tek_alatrumah == true){
            url = "http://gamnim.my.id/t_alatrumah.php";
        }
        else if (home.tek_mobil == true){
            url = "http://gamnim.my.id/t_mobil.php";
        }
        else if (home.tek_pc == true){
            url = "http://gamnim.my.id/t_pc.php";
        }
        else if (home.tek_print == true){
            url = "http://gamnim.my.id/t_print.php";
        }
        else if (home.tek_tv == true){
            url = "http://gamnim.my.id/t_tv.php";
        }
                                ...
                                for (int i = 0; i < numData; i++) {
                                    ...
                                    if (marker.getTitle().equals(nama[i])) {
                                        if (markerD[i]) {
                                            ...
                                            Intent intent = new Intent(MapsActivity.this, detailteknisi.class);
                                            ...
                                            Toast ts = Toast.makeText(MapsActivity.this,"Tap once again on marker, for detail Teknisi",Toast.LENGTH_LONG);
